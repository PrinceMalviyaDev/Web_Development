...
console.log(document.querySelector(".container").outerHTML);  // returns the container code as well as inner childs as well in text format.



console.log(document.querySelector(".container").tagName);   //for element childs only

console.log(document.querySelector(".container").nodeName);   //for element as well as text and comment childs as well.


console.log(document.querySelector(".container").textContent);  //returns all the text content inside the container including tab spaces and endlines too.
...
document.querySelector(".container").hidden = false;  // Unhides the element.
